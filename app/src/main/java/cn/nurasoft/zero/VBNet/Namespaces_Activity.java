...
public class Namespaces_Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.namespace_list);

        dbase = new DataBaseHelperClass(Namespaces_Activity.this);
        db = dbase.getReadableDatabase();


        String list[] = {"Accessibility", "Microsoft.Activities.Build", "Microsoft.Activities.Build.Debugger",
                "Microsoft.Activities.Build.Expressions", "Microsoft.Activities.Build.Validation",
                "Microsoft.Build.BuildEngine", "Microsoft.Build.Construction", "Microsoft.Build.Conversion",
                "Microsoft.Build.Debugging", "Microsoft.Build.Evaluation", "Microsoft.Build.Exceptions", "Microsoft.Build.Execution",
                "Microsoft.Build.Framework", "Microsoft.Build.Framework.XamlTypes", "Microsoft.Build.Logging",
                "Microsoft.Build.Tasks", "Microsoft.Build.Tasks.Deployment.Bootstrapper", "Microsoft.Build.Tasks.Deployment.ManifestUtilities",
                "Microsoft.Build.Tasks.Hosting", "Microsoft.Build.Tasks.Windows",
                "Microsoft.Build.Tasks.Xaml", "Microsoft.Build.Utilities",
                "Microsoft.CSharp", "Microsoft.CSharp.Activities",
                "Microsoft.CSharp.RuntimeBinder", "Microsoft.JScript",
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                final AlertDialog.Builder normalDialog = new AlertDialog.Builder(Namespaces_Activity.this);
                // normalDialog.setIcon(R.drawable.ic_launcher);
                String name = adapterView.getItemAtPosition(i).toString();
                normalDialog.setTitle(name);

                dbase.openDataBase();
                normalDialog.setMessage(dbase.get_namespaces(name));
                dbase.close();
